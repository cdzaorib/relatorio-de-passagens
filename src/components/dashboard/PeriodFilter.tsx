...
export function PeriodFilter({ period, today }: { period: Period; today: string }) {
  ...
  const campo =
    'dados w-full rounded-lg border border-line bg-surface px-3 py-2.5 text-ink outline-none transition focus:border-marca focus:ring-2 focus:ring-marca/20'
